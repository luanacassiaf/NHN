...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2 class="featurette-heading">Multimídia / Vídeos
            </h2> 
            <br/><br/>
            <div class="container">
                <div class="row">
                    <center><h3>Conheça nosso canal do Youtube: <a href="https://www.youtube.com/channel/UC_GjpT_74vICtGUT8yKfxOw" target="_blank">Núcleo de História Natural</a></h3></center>
                </div>
